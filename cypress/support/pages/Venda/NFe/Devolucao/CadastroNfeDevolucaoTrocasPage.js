...
class CadastroNfeDevolucaoTrocasPage extends CadastroNfeDevolucaoBasePage {
  avancarParaCadastroDevolucaoTrocas() {
    ...
    cy.get(CadastroNfeLocators.devolucao.trocas.campoData, { timeout: 15000 })
      .should('exist')
      .should('be.visible');
  }
  ...
  pesquisarDevolucaoTrocas(cliente = null) {
    ...
    cy.get(CadastroNfeLocators.devolucao.trocas.campoData, { timeout: 10000 })
      .should('be.visible')
    ...
    cy.get(CadastroNfeLocators.devolucao.trocas.campoData)
      .clear()
      .type(periodoData, { delay: 100 });

    if (cliente) {
      cy.get(CadastroNfeLocators.devolucao.trocas.campoCliente).clear().type(cliente, { delay: 200 });
    ...
    cy.get(CadastroNfeLocators.devolucao.trocas.tabelaResultados, { timeout: 15000 })
      .should('exist')
      .should('be.visible');
  }
...
export default CadastroNfeDevolucaoTrocasPage;
