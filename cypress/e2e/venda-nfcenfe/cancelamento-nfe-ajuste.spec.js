...
describe('Cancelamento NFe Ajuste', { tags: ['@nfe', '@vendas', '@regressivo', '@nfe-ajuste', '@cancelamento'] }, () => {
  beforeEach(() => {
    cy.login();
    cy.visit('/');
  ...
  it('emite e cancela NFe ajuste avulsa', () => {
    // Emitir NFe
    ...
    cy.wait(2000);
    CadastroNfeAjustePage.cancelarNFe('Teste automatizado - Cancelamento NFe Ajuste Avulsa');
  });
});
